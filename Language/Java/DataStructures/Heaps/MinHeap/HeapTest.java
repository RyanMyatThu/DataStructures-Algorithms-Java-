...
public class HeapTest {
    public static void main(String[] args) {
        System.out.println("=== Min Heap Implementation Tests ===\n");
        ...
        // Test 3: Adding multiple elements (min heap property)
        System.out.println("Test 3: Adding multiple elements [50, 30, 20, 15, 10]");
        Heap heap3 = new Heap();
        heap3.add(50);
        heap3.add(30);
        heap3.add(20);
        ...
        System.out.println("Expected minimum (peek): 10");
        System.out.println("Actual minimum (peek): " + heap3.peek());
        ...
        // Test 5: Poll operation (remove minimum)
        System.out.println("Test 5: Poll operation (remove minimum)");
        System.out.println("Initial minimum: " + heap3.peek());
        int polled = heap3.poll();
        System.out.println("Polled value: " + polled);
        System.out.println("Expected new minimum: 15");
        System.out.println("Actual new minimum: " + heap3.peek());
        System.out.println("Expected size after poll: 4");
        System.out.println("Actual size after poll: " + heap3.getSize());
        System.out.println("✓ Test 5 passed\n");

        // Test 6: Multiple poll operations (should maintain min heap property)
        System.out.println("Test 6: Multiple poll operations");
        System.out.println("Polling all elements in order:");
        int[] expectedOrder = {15, 20, 30, 50};
        for (int i = 0; i < expectedOrder.length; i++) {
            int min = heap3.poll();
            System.out.println("  Poll " + (i + 1) + ": " + min + " (expected: " + expectedOrder[i] + ")");
        }
        ...
        System.out.println("Test 7: Building heap from unsorted array [42, 17, 8, 31, 23, 5, 12]");
        Heap heap4 = new Heap();
        int[] unsorted = {42, 17, 8, 31, 23, 5, 12};
        ...
        System.out.println("Actual minimum: " + heap4.peek());
        System.out.println("✓ Test 7 passed\n");

        // Test 8: Poll all elements (should return in ascending order)
        System.out.println("Test 8: Polling all elements (should be in ascending order)");
        System.out.print("Polled values: ");
        while (heap4.getSize() > 0) {
            System.out.print(heap4.poll());
            if (heap4.getSize() > 0) {
                System.out.print(" < ");
            }
        }
        System.out.println();
        System.out.println("✓ Test 8 passed (all elements retrieved in ascending order)\n");

        // Test 9: Adding duplicate values
        System.out.println("Test 9: Adding duplicate values [5, 5, 10, 10, 15]");
        Heap heap5 = new Heap();
        heap5.add(5);
        heap5.add(5);
        heap5.add(10);
        ...
        System.out.println("First poll (should be 5): " + heap5.poll());
        System.out.println("Second poll (should be 5): " + heap5.poll());
        ...
        System.out.println("Actual minimum: " + heap6.peek());
        ...
        for (int i = 0; i < 100; i++) {
            ...
            if ((i + 1) % 10 == 0) {
                int min = heap7.poll();
                pollCount++;
                System.out.println("  After " + (i + 1) + " adds, polled: " + min + ", size: " + heap7.getSize());
            }
        }
        ...
        // Test 14: Verify min heap property after complex operations
        System.out.println("Test 14: Verify min heap property after complex operations");
        Heap heap8 = new Heap();
        int[] complexSequence = {100, 50, 75, 25, 60, 90, 10, 40, 80, 30};
        for (int num : complexSequence) {
            heap8.add(num);
        }
        System.out.println("Added: [100, 50, 75, 25, 60, 90, 10, 40, 80, 30]");
        System.out.println("Expected minimum: 10");
        System.out.println("Actual minimum: " + heap8.peek());
        
        // Poll first few and verify order
        int prev = heap8.poll();
        System.out.print("Polled sequence: " + prev);
        for (int i = 0; i < 4 && heap8.getSize() > 0; i++) {
            int current = heap8.poll();
            System.out.print(" < " + current);
            if (prev > current) {
                System.out.println("\n✗ Test 14 FAILED: Min heap property violated");
                return;
            }
            prev = current;
        }
        System.out.println();
        System.out.println("✓ Test 14 passed (min heap property maintained)\n");
        ...
        heap9.add(30);
        heap9.add(40);
        System.out.println("After adding [50, 30, 40]: peek = " + heap9.peek() + ", size = " + heap9.getSize());
        
        int poll1 = heap9.poll();
        System.out.println("After poll: " + poll1 + ", new peek = " + heap9.peek() + ", size = " + heap9.getSize());
        
        heap9.add(20);
        System.out.println("After adding 20: peek = " + heap9.peek() + ", size = " + heap9.getSize());
